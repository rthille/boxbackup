...
{ \
	...
	failures++; \
	BOX_ERROR("FAILURE: " msg " at " __FILE__ ":" << __LINE__); \
}
...
// TestGetFileSize() returns -1 if the file doesn't exist
...
// functions to send commands to bbackupd
void force_sync();
...
// Sleep without interruption on Unix (resleep if interrupted)
